...
| 模块                                            | 状态       | 作用                |
| --------------------------------------------- |:--------:| ----------------- |
| [核心流程](SKILL.md)                              | 🟢       | 研究 → 选路 → 规划         |
| [技术地图格式](references/technology-map-format.md) | 🟢       | 课程路线与课次地图               |
| [课次地图格式](references/lesson-map-format.md)     | 🟢       | 当前课介绍与学习规划             |
...
| `03` | 选择方向           | 提供未完成且不重复的主线与扩展方向                  |
| `04` | 选择课程           | 生成详细当前课地图，只介绍内容并给出学习规划        |
| `05` | 深入评估           | 仅在用户提出时评估路线、方向或扩展深入               |
